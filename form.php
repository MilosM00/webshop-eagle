...
<!-- START FORM -->
    ...
    <div class="form">
        ...
        <p style="padding-bottom:30px; font-size: 30px;">
            Popunite formu.
        </p>

        <form method="POST" action="hvala.php" id="form">
            <p style="text-align: left; width: 100%;"><label id="label-ime">Ime</label></p>
            <input id="input-ime" placeholder="Unesite ime..." name="Ime" type="text">

            <p style="text-align: left; width: 100%; padding-top: 20px;"><label id="label-prezime">Prezime</label></p>
            <input id="input-prezime" placeholder="Unesite prezime..." name="Prezime" type="text">

            <p style="text-align: left; width: 100%; padding-top: 20px;"><label id="label-email">Email</label></p>
            <input id="input-email" placeholder="Unesite email..." name="Email" type="text">

            <p style="text-align: left; width: 100%; padding-top: 20px;"><label id="label-broj-telefona">Broj telefona</label></p>
            <input id="input-broj-telefona" placeholder="Unesite broj telefona..." name="BrojTelefona" maxlength="10" type="text">

            <input type="hidden" value="<?php echo $Pack; ?>" name="Paket">

            <input id="submit-button" type="submit" value="NARUČI">
